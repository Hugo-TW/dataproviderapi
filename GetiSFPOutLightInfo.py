...
class iSFPOutLightInfo(BaseType):
    def __init__(self,indentity, start_time, end_time, line_type):
        super().__init__()
    ...
    def getData(self):
        try:
            ...
            sql =  """SELECT distinct t.data_type 
                        ...
                        where item_name = 'OUTPUT_LIGHT' 
                        and t.data_date between to_date('{0}','yyyy/mm/dd hh24miss') and to_date('{1}','yyyy/mm/dd hh24miss') 
                        and t.line_type = '{2}'
                        order by 1""".format(self.__start_time, self.__end_time, self.__line_type) 
            ...
            sql =  """select * from 
                        ...
                        order by decode(data_date,'MTD',1,2),data_date""".format(self.__start_time, self.__end_time, self.__sColnumName, self.__line_type) 
