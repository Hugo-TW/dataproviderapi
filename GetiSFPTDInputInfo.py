...
class iSFPTDInputInfo(BaseType):
            ...
            if(len(data_result) != 0):
                ...
                for da in data_result:
                    ...
                    for da_D in data:
                        ...
                        #         dataColor = 'red'
                        #     elif(float(da[iNum_data_list]) >= 2 and float(da[iNum_data_list]) <= 2.4):
                        #         dataColor = 'yellow' 
                        #     else:
                        #         dataColor = 'green'
                        ...
                        #         dataColor = 'red'
                        #     elif(float(da[iNum_data_list]) >= 95 and float(da[iNum_data_list]) <= 98):
                        #         dataColor = 'yellow' 
                        #     else:
                        #         dataColor = 'green'        
