...
class iSFPFPYScrapInfo(BaseType):
            ...
            sql =  """select * from 
                        (
                          ...
                          (
                            ...
                            FROM WAYNE_TEST_TV t 
                            where item_name in ('FPY_TOTAL','SCRAP_P') 
                            and t.data_date between to_date('{0}','yyyy/mm/dd hh24miss') and to_date('{1}','yyyy/mm/dd hh24miss')
                          ...
                          (
                            ...
                            and t.item_name in ('FPY_TOTAL','SCRAP_P')
                          )t1
            ...
            if(len(data_result) != 0):
                ...
                for da in data_result:
                    ...
                    for da_D in data:
                        ...
                        #         dataColor = 'red'
                        #     elif(float(da[iNum_data_list]) >= 90 and float(da[iNum_data_list]) <= 95):
                        #         dataColor = 'yellow' 
                        #     else:
                        #         dataColor = 'green'
